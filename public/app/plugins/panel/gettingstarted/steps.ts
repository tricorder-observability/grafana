...
const step1TutorialTitle = 'Tricorder fundamentals';
...
export const getSteps = (): SetupStep[] => [
  {
    heading: 'Welcome to Tricorder',
    subheading: 'The steps below will guide you to quickly finish setting up your Tricorder installation.',
    title: 'Basic',
    info: 'The steps below will guide you to quickly finish setting up your Tricorder installation.',
    done: false,
    cards: [
      {
        type: 'tutorial',
        ...
        info: 'Set up and understand Tricorder if you have no prior experience. This tutorial guides you through the entire process and covers the “Data source” and “Dashboards” steps to the right.',
