...
Extending the viewer role is useful for public Tricorder installations where you want anonymous users to be able to edit panels and queries, but not be able to save or create new dashboards.
